...
export default class Pdf extends Component {
    ...
    componentDidUpdate(prevProps) {
        ...
        if ((nextSource.uri !== curSource.uri || nextUniqueIdForCache !== curUniqueIdForCache)) {
    ...
    _prepareFile = async (source) => {
        try {
            if (source.uri) {
                ...
                this._onError(new Error('É preciso informar uma origem para o arquivo!'));
            }
        } catch (e) {
            this._onError(e)
        }
    ...
    _downloadFile = async (source, cacheFile) => {
        ...
        this.lastRNBFTask
            .then(async (res) => {
              ...
              this.lastRNBFTask = null;
                if (res.msgError) {
                  throw new Error("O arquivo solicitado não existe.");
                }
